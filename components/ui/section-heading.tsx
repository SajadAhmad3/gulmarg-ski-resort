  ...
  return (
    <div className={cn("flex flex-col items-center w-full mb-10", className)}>
      <div className="flex items-center w-full justify-center gap-4 mb-3">
        ...
        <span className="uppercase text-primary font-semibold tracking-widest text-lg md:text-xl">{topLine}</span>
        <span className="h-[2px] w-24 md:w-40 bg-primary rounded"></span>
      </div>
      <h2 className="font-extrabold text-3xl md:text-5xl text-center text-neutral-900 ">
        {heading}
      </h2>
    </div>
  );
